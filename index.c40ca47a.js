!function(){function e(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},i={},a=n.parcelRequired7c6;null==a&&((a=function(e){if(e in r)return r[e].exports;if(e in i){var t=i[e];delete i[e];var n={id:e,exports:{}};return r[e]=n,t.call(n.exports,n,n.exports),n.exports}var a=new Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){i[e]=t},n.parcelRequired7c6=a),a.register("euqRf",(function(e,t){a("fkNhc");var n=a("MjY8E");a("gQOBw");var r=a("G0OFq"),i=a("h6c0i"),o=(0,n.initializeApp)({apiKey:"AIzaSyCWbs0N9AYzirIviZZUsVMIJ2enE8aYPbw",authDomain:"bookstorecommunity.firebaseapp.com",projectId:"bookstorecommunity",storageBucket:"bookstorecommunity.appspot.com",messagingSenderId:"67705966282",appId:"1:67705966282:web:466a7777f399c2354fae33",measurementId:"G-X61KC3SJ2C"}),s=(0,r.o)(o),u=document.querySelectorAll("#all-registration-btns"),c=document.getElementById("modal-auth"),l=document.getElementById("close"),f=document.getElementById("signin-tab"),p=document.getElementById("signup-tab"),d=document.getElementById("signin-content"),h=document.getElementById("signup-content"),v=document.getElementById("signin-button"),m=document.getElementById("signup-button"),y=document.getElementById("user-auth"),g=document.getElementById("logaut-auth");function b(){var e=s.currentUser;e?(y.style.display="block",g.style.display="block",u.style.display="none",y.textContent=e.displayName):(y.style.display="none",g.style.display="none",u.style.display="block")}function k(){c.style.display="none",d.classList.remove("show"),f.classList.remove("is-active"),p.classList.add("is-active"),b()}function x(){c.style.display="none",y.style.display="block",y.textContent=user.displayName,g.style.display="block",b()}document.addEventListener("DOMContentLoaded",(function(){(0,r.x)(s,(function(e){e?(y.style.display="block",g.style.display="block",u.style.display="none",y.textContent=e.displayName):(y.style.display="none",g.style.display="none",u.style.display="block")}))})),document.addEventListener("keydown",(function(e){"Escape"===e.key&&"none"!==c.style.display&&k()})),l.addEventListener("click",(function(){k(),b()})),u.addEventListener("click",(function(){c.style.display="block",h.classList.add("show"),p.classList.add("is-active"),u.style.display="none"})),g.addEventListener("click",(function(){(0,r.B)(s).then((function(){console.log("User logged out"),i.Notify.success("Logged out successfully!")})).catch((function(e){console.error("Error logging out:",e),i.Notify.failure("Error logging out")})),b()})),f.addEventListener("click",(function(){d.classList.add("show"),h.classList.remove("show"),p.classList.remove("is-active"),f.classList.add("is-active")})),p.addEventListener("click",(function(){d.classList.remove("show"),h.classList.add("show"),f.classList.remove("is-active"),p.classList.add("is-active")})),v.addEventListener("click",(function(){var e,t;e=document.getElementById("email").value,t=document.getElementById("password").value,v.disabled=!0,v.textContent="Loading...",(0,r.a9)(s,e,t).then((function(e){var t=e.user;console.log("Successful user login:",t),i.Notify.success("Successful login!"),x(),b()})).catch((function(e){var t=e.code,n=e.message;console.error("User not found",t,n),i.Notify.failure("User not found")})).finally((function(){v.disabled=!1,v.textContent="SIGN IN"}))})),m.addEventListener("click",(function(){var e,t,n;e=document.getElementById("signup-email").value,t=document.getElementById("signup-password").value,n=document.getElementById("name").value,m.disabled=!0,m.textContent="Loading...",e&&t&&n?(0,r.ad)(s,e).then((function(a){a.length>0?(console.log("Email is already registered:",e),i.Notify.failure("Email is already registered"),m.disabled=!1,m.textContent="Sign Up"):(0,r.a8)(s,e,t).then((function(e){var t=e.user;return console.log("Successful user registration:",t),i.Notify.success("Successful registration!"),c.style.display="none",(0,r.ai)(s.currentUser,{displayName:n})})).then((function(){console.log("User profile updated:",s.currentUser.displayName),b()})).catch((function(e){var t=e.code,n=e.message;console.error("Error registering user:",t,n),i.Notify.failure("Error registering user")})).finally((function(){m.disabled=!1,m.textContent="Sign Up"}))})).catch((function(e){console.error("Error checking email existence:",e),i.Notify.failure("Error checking email existence"),m.disabled=!1,m.textContent="Sign Up"})):(console.log("Please fill in all fields."),i.Notify.failure("Please fill in all fields."),m.disabled=!1,m.textContent="Sign Up")}))})),a.register("fkNhc",(function(t,n){e(t.exports,"initializeApp",(function(){return a("MjY8E").initializeApp})),e(t.exports,"registerVersion",(function(){return a("MjY8E").registerVersion}));a("MjY8E");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];throw A.apply(void 0,[e].concat(t(h)(r)))}function C(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];return A.apply(void 0,[e].concat(t(h)(r)))}function O(e,n,r){var i=Object.assign(Object.assign({},I()),t(c)({},n,r));return new(0,y.ErrorFactory)("auth","Firebase",i).create(n,{appName:e.name})}function A(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];var a;if("string"!=typeof e){var o,s=r[0],u=t(h)(r.slice(1));return u[0]&&(u[0].appName=e.name),(o=e._errorFactory).create.apply(o,[s].concat(t(h)(u)))}return(a=_).create.apply(a,[e].concat(t(h)(r)))}function R(e,n){for(var r=arguments.length,i=new Array(r>2?r-2:0),a=2;a<r;a++)i[a-2]=arguments[a];if(!e)throw A.apply(void 0,[n].concat(t(h)(i)))}function P(e){var t="INTERNAL ASSERTION FAILED: "+e;throw S(t),new Error(t)}function D(e,t){e||P(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(e,t){D(e.emulator,"Emulator should always be set here");var n=e.emulator.url;return t?"".concat(n).concat(t.startsWith("/")?t.slice(1):t):n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var Ft=function(e){"use strict";t(p)(r,e);var n=t(v)(r);function r(e,a,o,u){var c,l;return t(s)(this,r),(c=n.call(this,a.code,a.message)).operationType=o,c.user=u,Object.setPrototypeOf(t(i)(c),r.prototype),c.customData={appName:e.name,tenantId:null!==(l=e.tenantId)&&void 0!==l?l:void 0,_serverResponse:a.customData._serverResponse,operationType:o},c}return t(u)(r,null,[{key:"_fromErrorAndOperation",value:function(e,t,n,i){return new r(e,t,n,i)}}]),r}(y.FirebaseError);function Bt(e,t,n,r){return("reauthenticate"===t?n._getReauthenticationResolver(e):n._getIdTokenResponse(e)).catch((function(n){if("auth/multi-factor-auth-required"===n.code)throw Ft._fromErrorAndOperation(e,n,t,r);throw n}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Ge("rcb"),new j(3e4,6e4);var Hn="recaptcha";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var xr=new j(3e4,6e4);function wr(){var e=In().___jsl,n=!0,r=!1,i=void 0;if(null==e?void 0:e.H)try{for(var a,o=Object.keys(e.H)[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var s=a.value;if(e.H[s].r=e.H[s].r||[],e.H[s].L=e.H[s].L||[],e.H[s].r=t(h)(e.H[s].L),e.CP)for(var u=0;u<e.CP.length;u++)e.CP[u]=null}}catch(e){r=!0,i=e}finally{try{n||null==o.return||o.return()}finally{if(r)throw i}}}var Ir=null;function _r(e){return Ir=Ir||function(e){return new Promise((function(t,n){var r,i,a;function o(){wr(),gapi.load("gapi.iframes",{callback:function(){t(gapi.iframes.getContext())},ontimeout:function(){wr(),n(C(e,"network-request-failed"))},timeout:xr.get()})}if(null===(i=null===(r=In().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(a=In().gapi)||void 0===a?void 0:a.load)){var s=Ge("iframefcb");return In()[s]=function(){gapi.load?o():n(C(e,"network-request-failed"))},Ke("https://apis.google.com/js/api.js?onload=".concat(s)).catch((function(e){return n(e)}))}o()}})).catch((function(e){throw Ir=null,e}))}(e),Ir}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
