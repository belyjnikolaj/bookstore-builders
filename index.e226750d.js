function e(e,t,n,i){Object.defineProperty(e,t,{get:n,set:i,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},r=t.parcelRequired7c6;null==r&&((r=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var o=new Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){i[e]=t},t.parcelRequired7c6=r),r.register("bMZn5",(function(t,n){e(t.exports,"checkAuthState",(function(){return C})),r("gKkQl");var i=r("ix4Jr");r("eyjy7");var o=r("la1jY"),s=r("iQIUW"),a=r("dSs1Y");const c=(0,i.initializeApp)({apiKey:"AIzaSyCWbs0N9AYzirIviZZUsVMIJ2enE8aYPbw",authDomain:"bookstorecommunity.firebaseapp.com",projectId:"bookstorecommunity",storageBucket:"bookstorecommunity.appspot.com",messagingSenderId:"67705966282",appId:"1:67705966282:web:466a7777f399c2354fae33",measurementId:"G-X61KC3SJ2C"}),l=(0,o.o)(c),u=document.getElementById("shoppingListButton"),d=document.getElementById("userInAuth"),h=document.getElementById("logOutAuth"),f=document.getElementById("signUpAuth"),p=document.getElementById("homeButton"),m=document.getElementById("shoppingListButtonMobile"),g=document.getElementById("userInAuthMobile"),y=document.getElementById("logOutAuthMobile"),v=document.getElementById("signUpAuthMobile"),b=document.getElementById("homeButtonMobile"),w=document.getElementById("modal-auth"),I=document.getElementById("close"),k=document.getElementById("signin-tab"),x=document.getElementById("signup-tab"),_=document.getElementById("signin-content"),E=document.getElementById("signup-content"),T=document.getElementById("signin-button"),N=document.getElementById("signup-button");function C(){a.Loading.standard("Loading...",{backgroundColor:"rgba(10,10,10,10)"});const e=l.currentUser;window.matchMedia("(min-width: 767px)").matches?e?(d.style.display="flex",u.style.display="block",p.style.display="block",f.style.display="none",d.textContent=e.displayName):(d.style.display="none",h.style.display="none",u.style.display="none",p.style.display="none",f.style.display="flex"):(u.style.display="none",p.style.display="none",f.style.display="none",h.style.display="none",e?(g.style.display="flex",y.style.display="flex",m.style.display="flex",b.style.display="flex",v.style.display="none",g.textContent=e.displayName):(g.style.display="none",y.style.display="none",m.style.display="none",b.style.display="none",v.style.display="flex")),a.Loading.remove()}function S(){w.style.display="none",_.classList.remove("show"),k.classList.remove("is-active"),x.classList.add("is-active"),C()}function A(){(0,o.B)(l).then((()=>{console.log("User logged out"),s.Notify.success("Logged out successfully!")})).catch((e=>{console.error("Error logging out:",e),s.Notify.failure("Error logging out")})),C()}document.addEventListener("DOMContentLoaded",(()=>{(0,o.x)(l,(e=>{window.matchMedia("(min-width: 767px)").matches?e?(d.style.display="flex",u.style.display="block",p.style.display="block",f.style.display="none",d.textContent=e.displayName):(d.style.display="none",h.style.display="none",u.style.display="none",p.style.display="none",f.style.display="flex"):(u.style.display="none",p.style.display="none",f.style.display="none",h.style.display="none",e?(g.style.display="flex",y.style.display="flex",m.style.display="flex",b.style.display="flex",v.style.display="none",g.textContent=e.displayName):(g.style.display="none",y.style.display="none",m.style.display="none",b.style.display="none",v.style.display="flex"))}))})),document.addEventListener("DOMContentLoaded",C()),document.addEventListener("keydown",(e=>{"Escape"===e.key&&"none"!==w.style.display&&S()})),I.addEventListener("click",(()=>{S(),C()})),v.addEventListener("click",(()=>{w.style.display="block",E.classList.add("show"),x.classList.add("is-active")})),f.addEventListener("click",(()=>{w.style.display="block",E.classList.add("show"),x.classList.add("is-active")})),y.addEventListener("click",(()=>{A()})),h.addEventListener("click",(()=>{A()})),k.addEventListener("click",(()=>{_.classList.add("show"),E.classList.remove("show"),x.classList.remove("is-active"),k.classList.add("is-active")})),x.addEventListener("click",(()=>{_.classList.remove("show"),E.classList.add("show"),k.classList.remove("is-active"),x.classList.add("is-active")})),T.addEventListener("click",(()=>{!function(){const e=document.getElementById("email").value,t=document.getElementById("password").value;T.disabled=!0,T.textContent="Loading...",(0,o.a9)(l,e,t).then((e=>{const t=e.user;console.log("Successful user login:",t),s.Notify.success("Successful login!"),S(),C()})).catch((e=>{const t=e.code,n=e.message;console.error("User not found",t,n),s.Notify.failure("User not found")})).finally((()=>{T.disabled=!1,T.textContent="SIGN IN"}))}()})),N.addEventListener("click",(()=>{!function(){const e=document.getElementById("signup-email").value,t=document.getElementById("signup-password").value,n=document.getElementById("name").value;N.disabled=!0,N.textContent="Loading...",e&&t&&n?(0,o.ad)(l,e).then((i=>{i.length>0?(console.log("Email is already registered:",e),s.Notify.failure("Email is already registered"),N.disabled=!1,N.textContent="Sign Up"):(0,o.a8)(l,e,t).then((e=>{const t=e.user;return console.log("Successful user registration:",t),s.Notify.success("Successful registration!"),S(),(0,o.ai)(l.currentUser,{displayName:n})})).then((()=>{console.log("User profile updated:",l.currentUser.displayName),C()})).catch((e=>{const t=e.code,n=e.message;console.error("Error registering user:",t,n),s.Notify.failure("Error registering user")})).finally((()=>{N.disabled=!1,N.textContent="Sign Up"}))})).catch((e=>{console.error("Error checking email existence:",e),s.Notify.failure("Error checking email existence"),N.disabled=!1,N.textContent="Sign Up"})):(console.log("Please fill in all fields."),s.Notify.failure("Please fill in all fields."),N.disabled=!1,N.textContent="Sign Up")}()})),d.addEventListener("click",(()=>{"flex"!==h.style.display?h.style.display="flex":h.style.display="none"}))})),r.register("gKkQl",(function(t,n){e(t.exports,"initializeApp",(function(){return r("ix4Jr").initializeApp})),e(t.exports,"registerVersion",(function(){return r("ix4Jr").registerVersion}));r("ix4Jr");
/**
 * @license
...
//# sourceMappingURL=index.e226750d.js.map
